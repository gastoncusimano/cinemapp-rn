...
class Login extends Component {
  constructor(props) {
    ...
    this.goToHome = () => {
      Keyboard.dismiss
      props.navigation.navigate('RootNavigation')
    };
  ...
  _keyboardDidShow = () => {
    this.setState({height: height - 350, margin_bottom: 350})
  }

  _keyboardDidHide = () => {
    this.setState({height: height, margin_bottom: 0})
  }
  ...
  render() {
    return (
      ...
      <View  style={{
        ...
        > 
          <Svg height={this.state.height + 70} width={width}>
            <ClipPath id="circle_white">
              <Circle
                r={this.state.height + 70}
                cx={width / 2}
              />
            </ClipPath>
            <Image 
